...
struct PrivateMessage {
    ...
    // Дополнительный конструктор для совместимости (но используем основной)
    PrivateMessage(const QString &sender, const QString &content, const QString &timestamp, bool isFromCurrentUser, bool forceRead)
